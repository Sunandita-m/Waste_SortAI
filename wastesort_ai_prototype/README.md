...
[![SDG 12](https://img.shields.io/badge/SDG-12-28a745?style=for-the-badge&logo=un&logoColor=white)](https://sdgs.un.org/goals/goal12)
...
[![AI](https://img.shields.io/badge/AI%20Powered-Pattern%20Matching-FF6B35?style=for-the-badge&logo=openai&logoColor=white)]()
...
|----------------------|----------------------------|
| ![Input Screen](https://via.placeholder.com/400x225/0d1117/28a745?text=🗑️+Type+your+waste+item) | ![Results Screen](https://via.placeholder.com/400x225/161b22/ffffff?text=♻️+Step-by-Step+Instructions) |
...
```mermaid
graph LR
    A[User Input] --> B{Pattern Matching AI};
    B --> C[Classification Engine];
    C --> D[Knowledge Base Lookup];
    D --> E[Impact Calculator];
    E --> F[Smart Recommendations];
    F --> G[🗑️ Clear Disposal Guide];
    
    style B fill:#28a745,color:white
    style C fill:#0d8ddb,color:white
```
